...
#- datatable
library(DT)
cc <- df %>% filter(yes_2_names != 0) %>% 
  select(NombreMuni, NombreProv, NombreCCAA)
datatable(cc, extensions = 'Scroller', caption = "Cuadro 3: Municipios con dos nombres oficiales", options = list( pageLength = 10, deferRender = TRUE, scrollY = 400,scroller = TRUE), rownames = F, filter = "top" )
...
Para finalizar una tabla con los 31 nuevos municipios con 2 nombres que han aparecido con el nuevo criterio.
